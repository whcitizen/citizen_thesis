function LF_Remap =  RAW2REMAP(Lytro_RAW_Demosaic,GridCoordsi_round,LF_parameters)
%RAW2REMAP
...
for x = 1:x_size
    for y = 1:y_size
        ...
        x_cord_center = GridCoordsi_round(y,x,1)                                ;
        y_cord_center = GridCoordsi_round(y,x,2)                                ;
